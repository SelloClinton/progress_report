...
class Constants{
	public:
		...
		static const float SEGMENT_WIDTH_;
		static const float SEGMENT_HEIGHT_;
		static const float MUSHROOM_WIDTH_;
		static const float MUSHROOM_HEIGHT_;
        static const float SEGMENT_SPEED_;
		static const float PLAYER_VERTICAL_LIMIT;
        static const float LASER_SPEED_;
		static const float X_LEFT_LIMIT_;
		static const float X_RIGHT_LIMIT_;
