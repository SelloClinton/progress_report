...
const int Constants::DISPLAY_WIDTH_= 800;
const int Constants::DISPLAY_HEIGHT_ = 600;
...
const int Constants::INITIAL_SIZE_OF_CENTIPEDE_ = 15;	//maximum
const int Constants::NUMBER_OF_MUSHROOMS = 50;
